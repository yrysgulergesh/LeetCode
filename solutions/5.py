#  Longest Palindromic Substring /  Самая длинная палиндромная подстрока
...
#   Учитывая строку s, вернуть самую длинную палиндромную подстроку в s. Строка называется строкой-палиндромом, если обратная сторона этой    строки совпадает с исходной строкой.
